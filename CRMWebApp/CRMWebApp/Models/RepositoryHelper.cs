namespace CRMWebApp.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerContactAndBankListRepository Getvw_CustomerContactAndBankListRepository()
		{
			var repository = new vw_CustomerContactAndBankListRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerContactAndBankListRepository Getvw_CustomerContactAndBankListRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerContactAndBankListRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
        ...
        //internal class Get客戶資料Repository : 客戶資料Repository
        //{
        //}
    }
}